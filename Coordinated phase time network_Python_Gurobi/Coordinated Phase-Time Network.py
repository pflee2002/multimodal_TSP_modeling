...
t4 = 120 #ending time of coordination phase 2 
# =============================================================================
...
while(len(line)):
    ...
    #for coordinated phase time network
    for (i,t,j,s) in links:
        if i == 2 and j==1 or i==3 and j ==1 or i==3 and j ==2 :
            cost[(start_phase,start_time,end_phase,end_time)]=100
        else:
            cost[(start_phase,start_time,end_phase,end_time)]=1 
        if t > t1 and t < t2:
            cost[(start_phase,start_time,end_phase,end_time)]=500
        if t > t3 and t < t4:
            cost[(start_phase,start_time,end_phase,end_time)]=500
# =============================================================================
